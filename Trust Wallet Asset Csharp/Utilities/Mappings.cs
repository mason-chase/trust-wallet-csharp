...
namespace TrustWallet.Asset.Utilities
{
    public static class Mappings
    {
        ...
        public static MapperConfiguration ValidatorMapperConfiguration { get; } = new MapperConfiguration(cfg =>
                cfg.CreateMap<Validator, StandardModels.CoinProperties.Validator>()
         );
    }
}
